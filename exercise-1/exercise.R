...
webdata <- GET("http://data.unhcr.org/api/stats/time_series_all_years.json?population_type_code=AS&country_of_origin=AFG&country_of_residence=CHE")
data <- fromJSON(content(webdata, "text"))
